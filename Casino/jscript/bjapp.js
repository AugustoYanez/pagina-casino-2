...
App.prototype = (function() { var pro = {};
  ...
  var showMessage = function ( status )
  {
      ...
      switch ( status ) {
        ...
        case 'win-blackjack': content = 'Ganaste <span>Blackjack</span>'; break;
        case 'win-dealer-busted': content = 'Ganaste <span>Crupier se paso</span>'; break;
        case 'lose': content = 'You lose'; break;
        case 'lose-blackjack': content = 'Perdiste<span>Blackjack</span>'; break;
        case 'lose-busted': content = 'Perdiste <span>Te pasaste</span>'; break;
        case 'push': content = 'Empate<span>Nadie gana</span>'; break;
        case 'game-over': content = 'Game over'; break;
        default: content = '<span>algo se rompió, no sabemos qué pasó...</span>'; break;
      }
